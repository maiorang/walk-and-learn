...
URL finali previsti (utente `maiorang`, repo `walk-and-learn`):
- Pagina:  `https://maiorang.github.io/walk-and-learn/`
- **Feed podcast:** `https://maiorang.github.io/walk-and-learn/podcast.xml`
...
4. Dopo 1-2 minuti il sito è online. Apri `https://maiorang.github.io/walk-and-learn/` per controllare.
...
git branch -M main
git remote add origin https://github.com/maiorang/walk-and-learn.git
git push -u origin main
```
Poi abilita **Settings → Pages** come al punto 3 dell'opzione A.

## Aggiungere il feed all'app podcast
Copia `https://maiorang.github.io/walk-and-learn/podcast.xml` e:
